...
import (
	...
	"dagger/nucleiscanner/internal/dagger"
	"dagger/nucleiscanner/internal/telemetry"
...
func (r Nucleiscanner) MarshalJSON() ([]byte, error) {
	var concrete struct{}
	return json.Marshal(&concrete)
}

func (r *Nucleiscanner) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Nucleiscanner":
		...
		case "ContainerEcho":
			...
			return (*Nucleiscanner).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent Nucleiscanner
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Nucleiscanner).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
			return nil, fmt.Errorf("unknown function %s", fnName)
		}
	case "":
		return dag.Module().
			WithDescription("A generated module for Nucleiscanner functions\n\nThis module has been generated via dagger init and serves as a reference to\nbasic module structure as you get started with Dagger.\n\nTwo functions have been pre-created. You can modify, delete, or add to them,\nas needed. They demonstrate usage of arguments and return types using simple\necho and grep commands. The functions can be called from the dagger CLI or\nfrom one of the SDKs.\n\nThe first line in this comment block is a short description line and the\nrest is a long description with more detail on the module's purpose or usage,\nif appropriate. All modules should have a short description.\n").
			WithObject(
				dag.TypeDef().WithObject("Nucleiscanner").
					WithFunction(
